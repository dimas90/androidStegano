...
@SuppressLint("SdCardPath") public class Filechoice extends ListActivity {
...
//			Toast.makeText(this, "Folder Clicked: "+ currentDir, Toast.LENGTH_SHORT).show();
			...
			intent.putExtra("GetFileName", currentDir.toString());
			intent.putExtra("GetFileName",currentDir.toString()+"/"+o.getName());
